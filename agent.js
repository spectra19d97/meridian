...
const INTENT_TOOLS = {
  ...
  close:       new Set(["close_position", "close_paper_position", "get_my_positions", "get_position_pnl", "get_wallet_balance", "swap_token", "get_paper_position"]),
  claim:       new Set(["claim_fees", "claim_paper_fees", "get_my_positions", "get_position_pnl", "get_wallet_balance", "get_paper_position"]),
  ...
  positions:   new Set(["get_my_positions", "get_position_pnl", "get_wallet_balance", "set_position_note", "get_wallet_positions", "list_paper_positions", "get_paper_position"]),
  strategy:    new Set(["list_strategies", "get_strategy", "add_strategy", "update_strategy", "delete_strategy", "remove_strategy", "set_active_strategy", "list_strategy_contracts", "get_strategy_contract"]),
  ...
  performance: new Set(["get_performance_history", "get_my_positions", "get_position_pnl", "list_paper_positions", "get_paper_position"]),
